    ...
    <Container className="mt-20 mb-40" fluid>
      <Center className="flex-col">
          ...
          <Flex className="mt-12 flex-wrap" columnGap="lg" rowGap="lg" justify="center">
            <Card shadow="sm" p="lg" radius="md" w={400} className="transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-105 duration-300 hover:shadow-xl" withBorder>
              <Card.Section>
                <Image
            ...
            <Card shadow="sm" p="lg" w={400} radius="md" className="transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-105 duration-300 hover:shadow-xl" withBorder>
              <Card.Section>
                <Image
            ...
            <Card shadow="sm" w={400} p="lg" radius="md" className="transition ease-in-out delay-10 hover:-translate-y-1 hover:scale-105 duration-300 hover:shadow-xl" withBorder>
              <Card.Section>
                <Image
