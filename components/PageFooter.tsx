import { Center, Flex, ActionIcon, Footer, Grid, Button, useMantineColorScheme } from '@mantine/core';
import { useViewportSize, useWindowScroll, useIdle } from '@mantine/hooks';
import { IconSun, IconMoonStars, IconBrandGithub, IconBrandInstagram, IconBrandLinkedin } from '@tabler/icons';
